...
import com.batchsphere.core.transcations.sampling.dto.SamplingContainerSampleRequest;
import com.batchsphere.core.transcations.sampling.dto.SamplingContainerSampleResponse;
...
import com.batchsphere.core.transcations.sampling.repository.SamplingContainerSampleRepository;
...
public class SamplingServiceImpl implements SamplingService {
    ...
    public SamplingRequestResponse createSamplingPlan(UUID samplingRequestId, CreateSamplingPlanRequest request) {
        ...
        replaceContainerSamples(plan.getId(), request.getContainerSamples(), request.getCreatedBy().trim());
        samplingRequest.setRequestStatus(SamplingRequestStatus.PLAN_DEFINED);
        samplingRequest.setUpdatedBy(request.getCreatedBy().trim());
    ...
    public SamplingRequestResponse updateSamplingPlan(UUID samplingRequestId, UUID planId, UpdateSamplingPlanRequest request) {
        ...
        plan.setUpdatedBy(request.getUpdatedBy().trim());
        plan.setUpdatedAt(LocalDateTime.now());
        samplingPlanRepository.save(plan);
        replaceContainerSamples(plan.getId(), request.getContainerSamples(), request.getUpdatedBy().trim());

        samplingRequest.setRequestStatus(SamplingRequestStatus.PLAN_DEFINED);
        samplingRequest.setUpdatedBy(request.getUpdatedBy().trim());
        samplingRequest.setUpdatedAt(LocalDateTime.now());
        samplingRequestRepository.save(samplingRequest);
    ...
    public SamplingRequestResponse completeSampling(UUID samplingRequestId, SamplingCompletionRequest request) {
        ...
        updateInventoryStatus(samplingRequest, InventoryStatus.UNDER_TEST, request.getUpdatedBy().trim());
        return toResponse(samplingRequest);
    }
    ...
    public SamplingRequestResponse recordQcDecision(UUID samplingRequestId, QcDecisionRequest request) {
        ...
        samplingRequest.setQcDecidedBy(request.getUpdatedBy().trim());
