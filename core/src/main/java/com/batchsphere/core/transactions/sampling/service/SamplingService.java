...
public interface SamplingService {
    ...
    QcInvestigationResponse completePhase2(UUID samplingRequestId, UUID investigationId, CompletePhase2Request request);
    ...
    byte[] buildWorksheetCsvTemplate(UUID samplingRequestId);

    List<QcTestResultResponse> importWorksheetCsv(UUID samplingRequestId, MultipartFile file, String actor);
}
